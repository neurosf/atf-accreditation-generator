...
const CartParticipante = (props) => {
  ...
  return (
    <>
      <div className="modal fade" id="CarprForm" tabIndex="-1" aria-hidden="true">
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content"  style={{ width: "500px", margin: "auto" }}>
            ...
            {}
                    <form className="modal-body" ref={pdfRef} style={{ textAlign: 'left',padding: 0}}>
...
export default CartParticipante;